...
class ImportController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $arrKeys = array_values($this->import->getColumnName());
        $arrValues = array_values($arrInput);
        $arrValues = [$arrInput['Date'], $arrInput['status'], $arrInput['price'], $arrInput['MaNCC']];
        $this->import->updateData(session('id'),array_combine($arrKeys, $arrValues) );
    ...
    public function store(Request $request) {
        ...
        $arrKeys = array_values($this->import->getColumnName());
        $arrValues = [$arrInput['Date'], $arrInput['status'], $totalImport, $arrInput['MaNCC']];

        $newIDImport = $this->import->store(array_combine($arrKeys, $arrValues)); 
