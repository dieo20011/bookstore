...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary d-flex justify-content-between">Danh sách tác giả
  ...
  <div class="card-body">
    <div class="table-responsive">
      <?php require_once("./Views/admin/author/loadTable.php")?>
    </div>
  </div>
</div>
<?php
    include('./Views/admin/includes/formDelete.php');
    include_once('./Views/admin/includes/scripts.php');
?> 
<script>
