...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary d-flex justify-content-between">Danh sách chương trình khuyến mãi
  ...
  <div class="card-body">
    <div class="table-responsive">
      <?php require_once("./Views/admin/promotion/loadTable.php")?>
    </div>
  </div>
</div>
<?php
