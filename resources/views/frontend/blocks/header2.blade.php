                ...
                <div class="app-header">
                    <div class="app-header-wrap">
                        ...
                        <div class="header-search">
                            <form action="{{ route('search') }}" class="header-form" method="GET">
                                <div class="group-input">
                                    <input type="search" name="search" placeholder="Tìm kiếm tựa sách, tác giả"
                        ...
                        <div class="header-cart-icon">
                            <span
                                class="number"><?php if(isset($data['cart']))echo count($data['cart']); else echo "0";?></span>
                            <label for="cart_list">
                     ...
                     ?>
                        <div class="header-link">
                            ...
                            <ul id="submenu-info">
                                <li><a class="submenu" href="?controller=user&action=showInfo">Thông tin cá nhân</a>
                                </li>
